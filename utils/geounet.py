...
class UNetModel(nn.Module):
    ...
    def forward(self, x: torch.Tensor, time_steps: torch.Tensor, cond: Optional[torch.Tensor] = None, attr: Optional[torch.Tensor] = None):
        """
        ...
        attr_emb = attr_emb[:,None,:]
        cond = torch.concat([attr_emb,cond],dim=1)
        # Input half of the U-Net
